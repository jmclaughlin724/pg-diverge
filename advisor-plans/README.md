...
| 012 | Monetization funnel, hosted CI policy design, agent governance support, and adoption audit services | P1 | L | MED | - | direction / monetization | DONE |
| 013 | Expanded monetization product roadmap, incumbent strategy, pricing meters, and execution system | P1 | L | MED | 012 | direction / monetization | DONE |

Status values: OPEN | IN PROGRESS | DONE | BLOCKED (one-line reason) | REJECTED (one-line rationale)
