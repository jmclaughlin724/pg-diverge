...
- Rule 13 owns packaged consumer hook templates. They contain only the Supaschema generated-artifact and schema-write commands; the repository's context runner and general Bash policy remain source-repo-only.
