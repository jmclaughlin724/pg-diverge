...
- Use structured APIs, language servers, compilers, and direct source reads for structural ownership, dependency, consumer, generated-surface, delete, rename, move, and rollout claims.
