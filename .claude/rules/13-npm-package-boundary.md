...
- Rule 18 owns the tracked-runtime boundary: source-repo hook runtime and rule surfaces stay tracked when tracked registration, guards, or `AGENTS.md` route to them, and personal or local DX stays gitignored.
