...
- Source-repo Codex hook commands MUST resolve repo-local entrypoints from `$(git rev-parse --show-toplevel)`. They MUST NOT rely on undocumented `CODEX_PROJECT_DIR` injection or the session working directory.
