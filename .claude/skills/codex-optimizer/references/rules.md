...
- Canonical rule prose and metadata live in `.claude/rules/**`.
- Generated Codex rule mirrors live in `.codex/rules/**`.
- Edit the `.claude/rules/**` owner, then run `pnpm sync:llm`.
