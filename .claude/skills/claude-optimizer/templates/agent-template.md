...
Use this template when defining a Codex subagent persona. Codex custom agents are TOML files under `.codex/agents/` or `~/.codex/agents/`. In supaschema, prefer editing the canonical owner and letting sync produce generated mirrors.
