...
2. **Generate the migration:**
   ...
   - `SUPA_DIFF_GENERATED_CONTRACT_DIRTY` / `SUPA_DIFF_MIGRATIONS_DIRTY` — generated contracts or migration files are already dirty before generation. Close that migration unit before running another diff.
