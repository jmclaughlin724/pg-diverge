...
- **Agent-ready workflow:** `supaschema init` installs a narrow Claude/Codex/AGENTS bundle that blocks generated migration edits and runs schema-write checks.
