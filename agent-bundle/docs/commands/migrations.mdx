...
| ------------------ | ------------ | ----------------------------------------------------------- |
| `--migrations-dir` | path         | Directory containing numbered migration files.              |
| `--database-url`   | url          | Target database whose applied history should be compared.   |
| `--history-table`  | schema.table | Migration history table. Use this for non-Supabase runners. |
| `--json`           | boolean      | Print the reconciliation report as JSON.                    |
