...
| -------- | ------- | ---------------------------------------------------- |
| `--from` | source  | Required source to audit against the support matrix. |
| `--json` | boolean | Print the audit report as JSON.                      |
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="files"
    href="/guides/declarative-postgres-schema-management"
  >
