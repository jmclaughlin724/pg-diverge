...
| ------------------ | ------- | ------------------------------------------------------------------------------------ |
| `--migrations-dir` | path    | Migration files directory. Defaults to `config.migrationsDir`.                       |
| `--dry-run`        | boolean | Print generated migration files that would be staged without changing the git index. |
