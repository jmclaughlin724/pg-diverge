...
| ---------------- | ------- | ------------------------------------------------------ |
| `--corpus-dir`   | path    | Corpus directory. Defaults to `corpus/supabase-style`. |
| `--database-url` | url     | Admin URL for disposable corpus databases.             |
| `--json`         | boolean | Print the corpus report as JSON.                       |
