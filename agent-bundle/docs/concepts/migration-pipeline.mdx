...
:::note
`apply` is the canonical package-owned apply pipeline. External runners are a deliberate integration choice when a team already has a separate deployment owner.
:::
