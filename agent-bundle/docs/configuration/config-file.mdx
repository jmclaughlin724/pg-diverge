...
:::note
For the object classes, provider surfaces, and unsupported DDL boundaries that determine what belongs in your declarative tree, see the [support matrix](/reference/support-matrix).
:::
