...
<CardGroup cols={2}>
  ...
  <Card title="type-contract" icon="file-warning" href="/commands/type-contract">
...
| Area | Default |
| --- | --- |
| `--from` | `config.sources.from`; `"auto"` resolves valid `git:HEAD`, then a database URL, then `empty:` |
