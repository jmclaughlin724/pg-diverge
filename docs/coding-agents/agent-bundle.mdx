...
| `sync-llm-on-claude-surface-change.mjs` | Claude and Codex `PostToolUse` | Keeps installed `.agents` and Codex mirrors aligned after canonical edits to the shipped `.claude` rule or skill. |
