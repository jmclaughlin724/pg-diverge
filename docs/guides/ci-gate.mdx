...
The gate is a command set: `diff --fail-on-diff`, `check`, and optional `verify`. This repository ships CLI and GitHub Action gates, not hosted CI, billing, marketplace distribution, or license enforcement.
...
- Whether your organization needs additional policy enforcement outside this
  repository.
