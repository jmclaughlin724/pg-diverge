---
title: "Sources"
description: "supaschema reads schemas from SQL files on disk, Git refs, SQL dump files, saved catalog snapshots, or explicit live-database workflows. No Docker or shadow database required."
keywords:
...
<Tip>
  ...
  for a first migration with no existing migration corpus.
