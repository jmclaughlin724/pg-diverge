---
title: "Schema Sources: How supaschema Reads Your Schema"
...
# Schema Sources: How supaschema Reads Your Schema

> supaschema reads schemas from SQL files on disk, Git refs, a live database, SQL dump files, or saved catalog snapshots. No Docker or shadow database required.
