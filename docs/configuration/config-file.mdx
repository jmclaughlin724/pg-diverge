...
Legacy adapter values (`postgres`, `supabase`, and `supabase-auto`) are accepted when loading older configs and normalized to `auto`. New configs should write `auto`.
...
| `workflow.schema_diff` | `"on_schema_write"` | See [Workflow policy](#workflow-policy). |
| `workflow.migration_check` | `"after_schema_diff"` | See [Workflow policy](#workflow-policy). |
| `workflow.migration_verify` | `"suggest_after_check"` | See [Workflow policy](#workflow-policy). |
| `workflow.migration_sync` | `"auto"` | See [Workflow policy](#workflow-policy). |
| `workflow.type_safety` | `"deploy_blocking"` | See [Workflow policy](#workflow-policy). |
| `workflow.rls_safety` | `"deploy_blocking"` | See [Workflow policy](#workflow-policy). |
| `workflow.type_generation` | `"create_or_refresh"` | See [Workflow policy](#workflow-policy). |
| `workflow.zod_generation` | `"create_or_refresh"` | See [Workflow policy](#workflow-policy). |
| `workflow.type_usage` | `"zod_validated"` | See [Workflow policy](#workflow-policy) and [ORM-free applications](/concepts/orm-free-applications). |
