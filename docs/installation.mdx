...
Install AI-agent enforcement only if I explicitly ask for it. In that case, read `node_modules/supaschema/agent-bundle/INSTALL.md`, then run `<local-runner> init --agent-bundle` or manually merge the reviewed raw bundle files.
