...
| Registry smoke | `scripts/release/registry-smoke.mjs` | After publish, npm, pnpm 11 with `minimumReleaseAge` disabled for the install, and Bun can download `supaschema@<version>` from the npm registry and execute the installed binary. |
