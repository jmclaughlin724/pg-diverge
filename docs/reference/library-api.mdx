...
| `generateDatabaseTypes` / `generateZodSchemas` | `types` | PostgreSQL TypeScript types in the Supabase-compatible `Database` shape, plus runtime Zod validators from a model. |
