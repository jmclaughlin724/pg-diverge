...
keywords: ["benchmarks","performance","accuracy","replay safety","Supabase CLI"]
---
...
<Frame>
  <img src="/images/benchmarks/head-to-head-xl.svg" alt="supaschema vs every Supabase CLI engine at 1,000 tables: latency bars, F1 accuracy, and replay-safety" />
</Frame>
...
<Frame>
  <img src="/images/benchmarks/head-to-head-xxl.svg" alt="supaschema vs every Supabase CLI engine at 2,500 tables: latency bars, F1 accuracy, and replay-safety" />
</Frame>
...
<Frame>
  <img src="/images/benchmarks/head-to-head-workflow-xl.svg" alt="Full workflow at 1,000 tables: supaschema migration plus refreshed type outputs in one command versus db diff, apply, and gen types per engine" />
</Frame>
...
<Frame>
  <img src="/images/benchmarks/xl-correctness.svg" alt="XL fixture correctness comparison across supaschema and Supabase CLI engines" />
</Frame>
