...
<Frame>
  <img
    ...
    alt="full workflow vs diff engines at 1,000 tables: supaschema migration plus refreshed type outputs in one command versus db diff, apply, and gen types per engine"
  />
</Frame>
