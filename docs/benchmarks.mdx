...
<Frame>
  <img
    ...
    alt="supaschema vs every Supabase CLI engine at 1,000 tables: latency bars, F1 accuracy, and replay-safety"
  />
</Frame>
...
<Frame>
  <img
    ...
    alt="supaschema vs every Supabase CLI engine at 2,500 tables: latency bars, F1 accuracy, and replay-safety"
  />
</Frame>
...
<Frame>
  <img
    ...
    alt="Full workflow at 1,000 tables: supaschema migration plus refreshed type outputs in one command versus db diff, apply, and gen types per engine"
  />
</Frame>
...
<Frame>
  <img
    ...
    alt="XL fixture correctness comparison across supaschema and Supabase CLI engines"
  />
</Frame>
