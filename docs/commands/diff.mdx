---
title: "supaschema diff: Generate SQL Migrations from Schema"
...
# supaschema diff: Generate SQL Migrations from Schema

> diff compares two schema sources and emits a replay-safe SQL migration. Supports --from, --to, --out, --watch, --fail-on-diff, and more.
