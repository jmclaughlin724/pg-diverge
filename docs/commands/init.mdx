...
The command scaffolds config, schema directories, migration directories, canonical `supaschema:*` package scripts, and path-confirmation state. It does not install active AI-agent rules, skills, hooks, settings, `AGENTS.md`, or `CLAUDE.md` by default.
