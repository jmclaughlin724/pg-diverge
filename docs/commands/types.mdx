---
title: "types"
description: "Generate Supabase-compatible TypeScript interfaces and Zod validators directly from PostgreSQL schema files."
...
<CardGroup cols={2}>
  <Card title="Type generation guide" icon="book-open" href="/guides/generate-supabase-types-without-database">
  ...
  <Card title="Quickstart" icon="terminal" href="/quickstart">
    See types in the first migration flow.
  </Card>
</CardGroup>
