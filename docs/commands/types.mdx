---
title: "supaschema types: Generate TypeScript Types from Schema"
...
# supaschema types: Generate TypeScript Types from Schema

> types generates Supabase-compatible TypeScript interfaces and Zod validators directly from your schema files — no database connection required.
