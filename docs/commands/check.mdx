---
title: "supaschema check: Validate Migration Replay Safety"
...
# supaschema check: Validate Migration Replay Safety

> check statically validates SQL migration files for replay-safety, lock hazards, and parser issues. Supports --reporter text, github, sarif, and json.
