...
| ------------------ | ---------------------- | ---------------------------------------------------------------------------------- |
| `--from`           | source                 | Override the before-state source used by safety and verification.                  |
| `--to`             | source                 | Override the target schema source used by safety and verification.                 |
| `--migrations-dir` | path                   | Directory containing migration files. Defaults to `config.migrationsDir`.          |
| `--database-url`   | url                    | Explicit target database used for history reconciliation and direct-runner apply.  |
