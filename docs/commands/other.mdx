...
<Accordion title="doctor — Diagnose your environment">
  `doctor` checks every component of your supaschema setup and reports a pass/fail result for each. Run it whenever something behaves unexpectedly or before adding supaschema to CI.
