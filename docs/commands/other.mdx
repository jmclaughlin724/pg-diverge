...
# supaschema Utility Commands: plan, audit, and corpus

> Reference for supaschema utility commands: plan, inspect, fingerprint, audit, corpus, doctor, init, completion, explain, and selfcheck.
