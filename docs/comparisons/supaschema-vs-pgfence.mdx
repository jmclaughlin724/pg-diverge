...
keywords:
  ["pgfence comparison", "postgres migration safety", "lock mode analysis", "libpg_query", "declarative sql"]
---
...
<Info>
  pgfence behavior described here was checked 2026-06-17 against the pgfence
  documentation. Confirm current behavior and licensing before relying on it.
</Info>

<CardGroup cols={2}>
  <Card title="Atlas lint is paid: free alternatives" icon="scale-balanced" href="/comparisons/atlas-migrate-lint-paid-alternatives">
