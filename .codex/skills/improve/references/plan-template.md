...
- Skills the executor should invoke if available, and for what: "use `ultracite` when applying the lint/format fixes in step 3".
...
- [ ] `npm test` exits 0; new tests for <X> exist and pass
